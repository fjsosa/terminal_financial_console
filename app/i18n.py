...
_ES_FALLBACK = {
    ...
    "calendar": "calendario",
    "palette": "palette",
    "NEWS // finviz.com (refresh {minutes}m)": "NEWS // finviz.com (refresh {minutes}m)",
    "Usage:": "Uso:",
    "Add failed:": "Error al agregar:",
    "Delete failed:": "Error al eliminar:",
    "Move failed:": "Error al mover:",
    "Edit failed:": "Error al editar:",
    "Add warning:": "Advertencia al agregar:",
    "Delete warning:": "Advertencia al eliminar:",
    "Move warning:": "Advertencia al mover:",
    "Edit warning:": "Advertencia al editar:",
    "type must be crypto or stock": "el tipo debe ser crypto o stock",
    "symbol and group are required": "symbol y grupo son obligatorios",
    "symbol already exists": "el symbol ya existe",
    "group not found": "grupo no encontrado",
    "invalid group schema": "esquema de grupo invalido",
    "could not persist config.yml": "no se pudo persistir config.yml",
    "added": "agregado",
    "deleted": "eliminado",
    "moved": "movido",
    "updated": "actualizado",
    ...
    "symbol not found": "symbol no encontrado",
    "destination group not found": "grupo destino no encontrado",
    "already in group": "ya esta en el grupo",
    "invalid token": "token invalido",
    "expected key=value": "se esperaba key=value",
    "unsupported field": "campo no soportado",
    "removed empty group": "grupo vacio removido",
    "Quick action:": "Accion rapida:",
    "symbol not found in configured groups": "symbol no encontrado en grupos configurados",
    "source": "fuente",
    "manual refresh requested": "refresh manual solicitado",
    "Local buffers reset": "buffers locales reiniciados",
    "Loading chart...": "Cargando grafico...",
}
